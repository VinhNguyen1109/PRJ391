                ...
                <div class="col-sm-9">
                    <div class="row">
                        <div class="row" id="ProductList">
                            <c:forEach items="${requestScope.listBestSelling}" var="c">
                                    ...
                                    <nav aria-label="Page navigation example" style="margin-top: 30px; margin-left: 300px">
                                        <ul class="pagination">
                                            ...
                                            <c:forEach begin="${1}" end="${requestScope.NumberOfPage}" var="num">
                                                <c:if test="${num == page}">
                                                    <li class="page-item" ><a class="page-link" style="background-color: orange" href="bestselling?page=${num}">${num}</a></li>
                                                    </c:if>
                                                    <c:if test="${num != page}">
                                                    <li class="page-item"><a class="page-link"  href="bestselling?page=${num}">${num}</a></li>
                                                    </c:if>                          
                                                </c:forEach>
