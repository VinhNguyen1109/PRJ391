                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <c:if test="${sessionScope.TypeOfUser == 1}">
                                            ...
                                            <div class="col" >
                                                <a href="adminmanager?ProductIDEdit=${c.getProductID()}" class="btn btn-success btn-block" style="margin-top: 10px">Edit Product</a>
                                            </div>  
                                        </c:if>
                                    </div>
                                </div>
                                ...
                                <nav aria-label="Page navigation example" style="margin-top: 30px; margin-left: 300px">
                                    <ul class="pagination">
                                        ...
                                        <c:forEach begin="${1}" end="${requestScope.NumberOfPage}" var="num">
                                            <c:if test="${num == page}">
                                                <li class="page-item" ><a class="page-link" href="search?page=${num}&TypeSearch=${requestScope.TypeSearch}&PriceFrom=${requestScope.PriceFrom}&PriceTo=${requestScope.PriceTo}" style="background-color: orange" >${num}</a></li>
                                                </c:if>
                                                <c:if test="${num != page}">
                                                <li class="page-item"><a class="page-link" href="search?page=${num}&TypeSearch=${requestScope.TypeSearch}&PriceFrom=${requestScope.PriceFrom}&PriceTo=${requestScope.PriceTo}" >${num}</a></li>
                                                </c:if>                          
                                            </c:forEach>
