    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-9">
                    <form action="addproductforcategory" method="post">
                        <div class="row">
                            <c:if test="${requestScope.listAll != null}">
                                    ...
                                    <div class="col-12 col-md-6 col-lg-4">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <c:if test="${sessionScope.TypeOfUser == 1}">
                                                    <div class="col" >
                                                        Input to category <input type="checkbox" name="ProductAdd" value="${c.getProductID()}" > 
                                                    </div>
                                                </c:if>
                                            </div>
                                        </div>
                            ...
                            <c:if test="${requestScope.listAll == null}">
                                <c:forEach items="${requestScope.listAllProductHaveCategoryID}" var="c">
                                    <div class="col-12 col-md-6 col-lg-4">
                                        <div class="card">
                                            <img class="card-img-top" style="width: 300px; height: 300px" src="${c.getImage()}" alt="Card image cap">
                                            <div class="card-body">
                                                ...
                                                <c:if test="${sessionScope.TypeOfUser == 1}">
                                                    <div class="col" >
                                                        Input to category <input type="checkbox" name="ProductAdd" value="${c.getProductID()}" checked> 
                                                    </div>
                                                </c:if>
                                            </div>
                                        </div>
                                ...
                                <c:forEach items="${requestScope.listAllProductNotHaveCategoryID}" var="c">
                                    <div class="col-12 col-md-6 col-lg-4">
                                        <div class="card">
                                            <img class="card-img-top" style="width: 300px; height: 300px" src="${c.getImage()}" alt="Card image cap">
                                            <div class="card-body">
