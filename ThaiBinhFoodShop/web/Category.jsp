    ...
    <body>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="bestselling">Best - Selling Product</a></li>
                                ...
                                <c:if test="${sessionScope.TypeOfUser == 1}">
                                <li class="breadcrumb-item active"><a href="addproductforcategory?CategoryID=${requestScope.CategoryID}">Insert Product To Category?</a></li>
                                </c:if> 
                        </ol>
                    </nav>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <c:if test="${requestScope.listProductByCategoryID == null}">
                    <div class="col">
                        <h1>0 Product</h1>
                    </div>
                </c:if>
                ...
                <div class="col-sm-9">
                    <div class="row">
                        ...
                        <c:forEach items="${requestScope.listProductByCategoryID}" var="c">
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <c:if test="${sessionScope.TypeOfUser == 1}">
                                            <div class="col" >
                                                <a href="#" onclick="doDelete('${c.getProductID()}')"class="btn btn-success btn-block" style="margin-top: 10px">Delete Product</a>
                                            </div>
                                            <div class="col" >
                                                <a href="adminmanager?ProductIDEdit=${c.getProductID()}&thispage=category&categoryid=${requestScope.CategoryID}" class="btn btn-success btn-block" style="margin-top: 10px">Edit Product</a>
                                            </div>
                                        </c:if>
                                    </div>
                                </div>
                                ...
                                <nav aria-label="Page navigation example" style="margin-top: 30px; margin-left: 300px">
                                    <ul class="pagination">
                                        ...
                                        <c:forEach begin="${1}" end="${requestScope.NumberOfPage}" var="num">
                                            <c:if test="${num == page}">
                                                <li class="page-item" ><a class="page-link" style="background-color: orange" href="categoryhome?page=${num}&CategoryID=${requestScope.CateID}">${num}</a></li>
                                                </c:if>
                                                <c:if test="${num != page}">
                                                <li class="page-item"><a class="page-link"  href="categoryhome?page=${num}&CategoryID=${requestScope.CateID}">${num}</a></li>
                                                </c:if>                          
                                            </c:forEach>
